...
for uploaded_f in uploaded_file:
    ...
    with col2:
        ...
        # vshows2 = (df[df['商品コード'].isin(['103','105','109','111','112','113','114','115','116','117','118','119','123','124','125','126','127','128','131','148','152','153','154','155','201','217','218','220','230','231','243','247','258'])])
