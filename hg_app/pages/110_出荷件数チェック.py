...
for uploaded_f in uploaded_file:
    ...
    with col2:
        ...
        shows2 = (df[df['商品コード'].isin(['103','146','105','109','111','112','113','114','115','116','117','118','119','123','124','125','126','127','128','131','148','152','153','154','155','201','217','218','220','230','231','243','247','258'])])
        st.dataframe(shows2.loc[:, ['受注番号', '会員氏名','商品コード']])
    with col3:
        if len(shows2) > 0:
            st.write(f'<span style="color:red;font-weight:bold;font-size: 48px">旧商品にご注意ください！！！</span>', unsafe_allow_html=True)
            st.text('旧商品一覧。')
